type FormProps = React.PropsWithChildren<React.HTMLAttributes<HTMLFormElement>>
...
type FormSectionProps = React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>>
