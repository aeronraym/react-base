...
type TableHeaderCellProps = React.PropsWithChildren<React.HTMLAttributes<HTMLTableCellElement>>
...
type TableRowProps = React.PropsWithChildren<React.HTMLAttributes<HTMLTableRowElement>>
...
type TableProps = React.PropsWithChildren<React.HTMLAttributes<HTMLTableElement>>
...
type TableContainerProps = React.PropsWithChildren<React.HTMLAttributes<HTMLDivElement>>
